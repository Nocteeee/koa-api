...
module.exports = (options) => {
    ...
    const logger = Log({ env, appLogLevel, dir }, 'cheese');
    ...
    return async (ctx, next) => {
        ...
        ctx.log = global.log = contextLogger;
        ...
        // 将执行时间记录logger.info
        logger.info(`${ctx.url} ========>  响应时间为${responseTime / 1000}s`)
    }
}